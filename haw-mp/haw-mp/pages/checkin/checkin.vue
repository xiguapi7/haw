<template>
    <view>
        <camera v-if="showCamera" device-position="front" flash="off" class="camera" @error="cameraError"></camera>
        <image v-if="showImage" mode="widthFix" class="image" :src="photoPath"></image>
