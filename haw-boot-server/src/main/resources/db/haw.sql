...
(
    ...
    `param_key`   varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '参数名',
    `param_value` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '参数值',
...
(
    ...
    `action_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '行为编号',
    `action_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '行为名称',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE INDEX `unq_action_name` (`action_name`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 8
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '行为表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `address`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '签到地址',
    ...
    `district`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '区划',
  ...
  AUTO_INCREMENT = 33
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '签到表'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`   int(10) UNSIGNED                                              NOT NULL AUTO_INCREMENT COMMENT '主键',
    `city` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '城市名称',
    `code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '拼音简称',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_city` (`city`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 330
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '疫情城市列表'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`        int(10) UNSIGNED                                              NOT NULL AUTO_INCREMENT COMMENT '主键',
    `dept_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '部门名称',
    PRIMARY KEY (`id`) USING BTREE,
...
(
    ...
    `user_id`    int(10) UNSIGNED                                      NOT NULL COMMENT '用户ID',
    `face_model` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户人脸模型',
    PRIMARY KEY (`id`) USING BTREE,
...
(
    ...
    `title`       varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会议题目',
    `creator_id`  bigint(200)                                                   NOT NULL COMMENT '创建人ID',
    `date`        date                                                          NOT NULL COMMENT '日期',
    `place`       varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开会地点',
    ...
    `desc`        varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会议内容',
    `instance_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '工作流实例ID',
  ...
  AUTO_INCREMENT = 48
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会议表'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`          int(10) UNSIGNED                                              NOT NULL AUTO_INCREMENT COMMENT '主键',
    `module_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模块编号',
    `module_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模块名称',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE INDEX `unq_module_id` (`module_code`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '模块资源表'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`              int(10) UNSIGNED                                              NOT NULL AUTO_INCREMENT COMMENT '主键',
    `permission_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限',
...
(
    `id`          int(10) UNSIGNED                                                NOT NULL AUTO_INCREMENT COMMENT '主键',
    `open_id`     varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci   NULL DEFAULT NULL COMMENT '长期授权字符串',
    `nickname`    varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci   NULL DEFAULT NULL COMMENT '昵称',
    `photo`       varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci   NULL DEFAULT NULL COMMENT '头像网址',
    ...
    `tel`         char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci       NULL DEFAULT NULL COMMENT '手机号码',
